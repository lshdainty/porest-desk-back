...
public interface MemoFolderService {
    ...
    MemoServiceDto.FolderInfo updateFolder(Long folderId, Long userRowId, MemoServiceDto.FolderUpdateCommand command);
    void deleteFolder(Long folderId, Long userRowId);
}
