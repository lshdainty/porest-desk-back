    ...
    public record EventInfo(
        ...
        public static EventInfo from(CalendarEvent event, List<EventReminderServiceDto.ReminderInfo> reminders) {
            return new EventInfo(
                ...
                event.getEndDate(),
                event.getIsAllDay(),
                event.getActiveLabel() != null ? event.getActiveLabel().getRowId() : null,
                event.getActiveLabel() != null ? event.getActiveLabel().getLabelName() : null,
                event.getActiveLabel() != null ? event.getActiveLabel().getColor() : null,
                event.getLocation(),
                event.getRrule(),
