...
public class Expense extends AuditingFieldsWithIp {
    ...
    public static Expense createExpense(User user, ExpenseCategory category, ExpenseType expenseType,
    ...
    public void updateExpense(ExpenseCategory category, ExpenseType expenseType, Long amount,
