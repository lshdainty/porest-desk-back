...
public enum SmsCardIssuer {
    ...
    SHINHAN("신한카드", List.of("신한카드", "신한체크", "신한",
        "신한은행", "슈퍼SOL", "신한SOL")),
    SAMSUNG("삼성카드", List.of("삼성카드", "삼성체크", "삼성", "모니모")),
    HYUNDAI("현대카드", List.of("현대카드", "현대체크", "현대")),
    LOTTE("롯데카드", List.of("롯데카드", "롯데체크", "롯데", "디지로카")),
    WOORI("우리카드", List.of("우리카드", "우리체크", "우리BC", "우리",
        "우리은행", "우리WON")),
    HANA("하나카드", List.of("하나카드", "하나체크", "하나", "하나은행", "하나원큐")),
    ...
    /** 인터넷은행 — 체크카드 승인이 은행 이름으로 온다. */
    KBANK("케이뱅크", List.of("케이뱅크", "K뱅크", "kbank")),
    IBK("기업은행", List.of("기업은행", "IBK기업", "IBK", "i-ONE"));
